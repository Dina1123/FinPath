...
#     profile.life_situations = data.get("life_situations", [])
#     profile.is_student = data.get("is_student", False)
#     profile.is_international = data.get("is_international", False)
#     profile.country_of_origin = data.get("country_of_origin")
#     profile.entry_route = data.get("entry_route")
#     profile.income_sources = data.get("income_sources", [])
#     profile.housing_type = data.get("housing_type")
...
#     profile.likely_gig_driver = any(
#         src in profile.income_sources
#         for src in {"gig_delivery_work"}
#     )
